    ...
    >
      {piece && (
        <span
          ...
          style={{
            // コンテナ幅の約 7.5% をフォントサイズに (9マスで合計100%)
...
function PVBoardGrid({ board, fromKey, toKey }) {
  ...
  return (
    // @container により cqw が使える
    <div className="flex flex-col" style={{ containerType: 'inline-size' }}>
      {/* 筋ラベル */}
      <div className="grid mb-0.5" style={{ gridTemplateColumns: 'repeat(9, 1fr) 16px' }}>
        {FILES.map(f => (
    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-[10px] text-gray-500 uppercase tracking-wider mb-0.5">読み筋プレビュー</p>
